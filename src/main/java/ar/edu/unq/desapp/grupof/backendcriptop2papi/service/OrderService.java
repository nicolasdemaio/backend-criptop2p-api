...
public class OrderService {
    ...
    @Autowired
    public OrderService(OrderRepository orderRepository, QuotationService quotationService, OperationRepository operationRepository,ContextService contextService) {
